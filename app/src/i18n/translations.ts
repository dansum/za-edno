...
const bg = {
  ...
  history: "История",
  outline: "Очертание",
  outlineTitle: "Очертание на картата",
  nodeCountWarning: (n: number) =>
    `Голяма карта: ${n} клетки. Много големите карти може да натоварят браузъра.`,
  file: "Файл",
  viewMenu: "Изглед",
  viewCenterRoot: "Центрирай върху главната клетка",
  viewPanLeft: "← Премести наляво",
  viewPanRight: "→ Премести надясно",
  viewPanUp: "↑ Премести нагоре",
  viewPanDown: "↓ Премести надолу",
  zoomIn: "Приближи",
  zoomOut: "Отдалечи",
  zoomFit: "Побери цялата карта в екрана",
  search: "Търсене",
  help: "Помощ",
  language: "Език",
  ...
  networkDisconnected: "Връзката прекъсна — работите локално, промените ще се качат при връщане на връзката.",
  networkReconnected: "Връзката се възстанови.",
  moveRejected: "Местенето не е позволено (възел не може да застане под собствения си потомък).",
  ...
  exportFailed: "Износът не успя — пробвайте пак.",
  saveCopyToNewRoom: "Запази копие в нова стая",
  saveCopyFailed: "Не успях да запазя копието — пробвайте пак.",
  templatePrefix: "Шаблон:",
  templateMathLesson: "Урок по математика",
  templateBrainstorm: "Брейнсторминг",
  templateTechPlan: "Стратегически план за технология",
  ...
  keyArrowsCanvas: "местене на изгледа (докато е избрано платното, не клетка)",
  ...
  toolbarDuplicate: "Дублирай клетката с цялото ѝ поддърво",
  multiSelectCount: (n: number) => `Избрани: ${n}`,
  multiSelectDeleteAll: "Изтрий всички избрани",
  editConflictMessage: "Друг участник промени тази клетка междувременно.",
  editConflictKeepMine: "Запази моето като нова клетка",
  editConflictTakeTheirs: "Вземи неговата версия",
...
const en: Dictionary = {
  ...
  history: "History",
  outline: "Outline",
  outlineTitle: "Map outline",
  nodeCountWarning: (n: number) => `Large map: ${n} cells. Very large maps may slow down the browser.`,
  file: "File",
  viewMenu: "View",
  viewCenterRoot: "Center on the main cell",
  viewPanLeft: "← Move left",
  viewPanRight: "→ Move right",
  viewPanUp: "↑ Move up",
  viewPanDown: "↓ Move down",
  zoomIn: "Zoom in",
  zoomOut: "Zoom out",
  zoomFit: "Fit the whole map on screen",
  search: "Search",
  help: "Help",
  language: "Language",
  ...
  networkDisconnected: "Connection lost — working locally, changes will upload once reconnected.",
  networkReconnected: "Connection restored.",
  moveRejected: "That move isn't allowed (a node can't become its own descendant's child).",
  ...
  saveCopyToNewRoom: "Save a copy in a new room",
  saveCopyFailed: "Couldn't save the copy — please try again.",
  templatePrefix: "Template:",
  templateMathLesson: "Math lesson",
  templateBrainstorm: "Brainstorm",
  templateTechPlan: "Tech-adoption strategic plan",
  ...
  keyArrowsCanvas: "pan the view (while the canvas is focused, not a cell)",
  ...
  toolbarDuplicate: "Duplicate the cell with its whole subtree",
  multiSelectCount: (n: number) => `Selected: ${n}`,
  multiSelectDeleteAll: "Delete all selected",
  editConflictMessage: "Another participant changed this cell in the meantime.",
  editConflictKeepMine: "Save mine as a new cell",
  editConflictTakeTheirs: "Take their version",
